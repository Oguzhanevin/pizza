            ...
            <Container>
                <Row>
                            ...
                            {selectSize.map((selectedItem, index) => (
                                <label className='option-label' key={index}>
                                    <input 
                                        ...
                                        checked={formData.size === selectedItem}
                                    />
                                    {selectedItem}
                                </label>
                            ))}
                    ...
                    <Col className='select-dough'>
                        ...
                        <div>
                            <select 
                                className='dough-selector' 
                                name="doughTickness" 
                                onChange={handleChange} 
                                value={formData.doughTickness}
                            >
                                {selectDough.map((selectedItem, index) => (
                                    <option 
                                        key={index} 
                                        value={selectedItem} 
                                        hidden={selectedItem === 'Hamur Kalınlığı'}
                                    >
                                        {selectedItem}
                                    </option>
                                ))}
                ...
                <Row>
                    <div className='text'>
                        <label className='form-subtitle'>İsim</label>
                        <input 
                    ...
                    <div className='text'>
                        <label className='form-subtitle'>Sipariş Notu</label>
                        <input 
                ...
                <Row className='check-out'>
                    ...
                    <Col xs='7' className='column-totals'>
                        <div className='total-calc'>
                            ...
                            <div className='calcname-calc'>
                                <label>Seçimler</label>
                                <label>{parseFloat(formData.toppingCost).toFixed(2)}₺</label>
                            </div>
                            <div className='calcname-calc'>
                                <label className='all-totals'>Toplam</label>
                                <label className='all-totals'>{parseFloat(formData.totalCost).toFixed(2)}₺</label>
                            </div>
                        </div>
